...
def play_game():
    if request.method == 'GET':
        ...
        return render_template('play.html', logo=logo, user_cards=user_cards, computer_card=computer_cards[0], user_score=user_score)
    ...
    if request.method == 'POST':
        ...
        if request.form.get('action') == 'draw':
            ...
            if user_score > 21:
                return render_template('result.html', logo=logo, user_cards=user_cards, computer_cards=computer_cards, result="YOU WENT OVER! YOU LOSE!", 
            ...
            return render_template('result.html', logo=logo, user_cards=user_cards, user_score=user_score, computer_score=computer_score, 
